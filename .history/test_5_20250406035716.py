...
def main(args):
    ...
    if image is not None:
        ...
        # Start audio generation/playback in a thread
        if args.generate_audio:
            audio_thread = threading.Thread(target=generate_audio, args=(results, CLASSES, 5))
            audio_thread.start()
        ...
        # Wait until user closes the window or presses a key
        cv2.waitKey(0)
